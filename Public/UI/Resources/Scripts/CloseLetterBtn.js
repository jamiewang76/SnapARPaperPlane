...
//@ui {"widget":"group_end"}
//@input SceneObject targetBtn
//@input SceneObject letter
//@input SceneObject completeBtn
...
function pressDown() {
    ...
    //script.getSceneObject(originalBtn).enabled = true;
...
function pressUp() {
    ...
    script.targetBtn.enabled = true;
    sceneObject.enabled = false;
    script.letter.enabled = false;
    script.completeBtn.enabled = false;
