...
//@input SceneObject inboxBtn
//@input SceneObject foldGif
//@input SceneObject sendBtn

//@input Component.ScriptComponent myTextScript
/** @type {ScriptComponent} */
var myTextScript = script.myTextScript;
...
function pressUp() {
    ...
    script.writeLetterBtn.enabled = true;
    script.inboxBtn.enabled = true;
    script.foldGif.enabled = false;
