...
//@input SceneObject inbox
//@input SceneObject writeLetterBtn
//@input Component.Text messageListText
//@input Component.ScriptComponent myTextScript

//@input string messageList
...
function pressDown() {
    ...
    script.inbox.enabled = true;
    script.closeBtn.enabled = true;
    script.writeLetterBtn.enabled = false;
    
    var myList = script.myTextScript.getMyList();
//    const msgArray = script.messageList.split(",");
    
    script.messageListText.text = "";
    for (var i=0; i<myList.length; i++){
       script.messageListText.text += myList[i].text + "\r\n";
    }
//    for (let i = 0; i < msgArray.length; i++){
//        print(i)
//        //script.messageListText.text = msgArray.join(i.toString()+"\r\n");
//    }
}
